            ...
            <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                ...
                <div >
                    <div class="item-container">
                        <div class="item-owl" style="width: 277.5px; margin-right: 10px;">
                            <div lass="item-hi">
                                <a href="https://www.facebook.com/kiennguyen1347/?locale=vi_VN" target="blank"><img src="{{ asset('frontend/img/unknown-avatar.jpg') }}"
                                        alt="Trang cá nhân nickvn" />FB chủ shop</a>
                            </div>

                        </div>
                        <div class="item-owl" style="width: 277.5px; margin-right: 10px;">
                            <div lass="item-hi">
                                <a href="{{ route('dichvu') }}"><img src="{{ asset('frontend/img/unnamed.jpg') }}"
                                        alt="Trang cá nhân nickvn" />Dịch vụ mua thẻ </a>
                            </div>

                        </div>
                        <div class="item-owl" style="width: 277.5px; margin-right: 10px;">
                            <div lass="item-hi">
                                <a href="{{ route('dichvu') }}"><img
                                        src="{{ asset('frontend/img/pmfecHJvZY_1656036635.png') }}"
                                        alt="Trang cá nhân nickvn" />Dịch vụ nạp thẻ cào</a>
                            </div>
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                <div class="news_image">
                                    ...
                                    <a href="{{ route('danhmucgame', [$cate->slug]) }}" title="{{ $cate->title }}">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom72 view">
                                                <a href="{{ route('danhmucgame', [$cate->slug]) }}" class=""
                                                    title="{{ $cate->title }}">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom72 {
