                ...
                <form class="form-horizontal form-find m-b-20" role="form" method="get" data-hs-cf-bound="true">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <a class="btn c-btn-square m-b-10 btn-danger" href="">Tất cả</a>
                        </div>
                    </div>
                </form>
                <div class="row">
                    <div class="col-md-9">
                        <div class="art-list">
                            @foreach ($blogs as $ket => $blog)
                                <div class="a-item">
                                    <div class="thumbnail-image img-thumbnail"><a
                                            href="{{ route('blogs_detail', $blog->slug) }}">
                                            <img src="{{ asset('uploads/blogs/' . $blog->image) }}" alt="png-image"></a>
                                    </div>
                                    <div class="info">
                                        <div class="article_title ">
                                            <h2><a href="{{ route('blogs_detail', $blog->slug) }}"
                                        ...
                                        <div class="article_cat_date">
                                            <div style="display: inline-block;margin-right: 15px"><i class="fa fa-calendar"
                                                    aria-hidden="true"></i> 25/01/2022</div>
                    ...
                    <div class="col-md-3">
                        <div class="c-content-ver-nav">
                            ...
                            <ul class="c-menu c-arrow-dot1 c-theme">
                                ...
                                <li><a href="https://www.dmca.com/Protection/Status.aspx?ID=6766daa6-8986-40c5-b282-a9c9e6a883de&refurl=https://WebTrade/">Uy Tín Của WebTrader</a></li>
