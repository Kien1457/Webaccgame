        ...
        <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="alert alert-info box-text showtext" role="alert">
                        ...
                        <table align="center" border="1" cellpadding="1" cellspacing="1"
                            ...
                            <tbody>
                                <tr>
                                    <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Mua acc Liên
                                                    Quân giá rẻ</strong></span></span></td>
                                    <td><span style="color:#000000"><span style="font-size:16px"><strong>⭐&nbsp;Giá rẻ nhất
                                                    thị trường chỉ từ 1k, 7k, 9k. Cho phép trả góp</strong></span></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Mua nick
                                                    Liên Quân uy tín</strong></span></span></td>
                                    <td><span style="color:#000000"><span style="font-size:16px"><strong>⭐&nbsp;Acc 100%
                                                    đúng mật khẩu, đúng như hình, 1 đổi 1&nbsp;nick
                                                    sai</strong></span></span></td>
                                </tr>
                                <tr>
                                    <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Mua acc Liên
                                                    Quân nhanh</strong></span></span></td>
                                    <td><span style="color:#000000"><span style="font-size:16px"><strong>⭐ Giao dịch và
                                                    check tự động, nhận acc sau 30s</strong></span></span></td>
                                </tr>
                                <tr>
                                    <td><span style="color:#000000"><span style="font-size:16px">✅&nbsp;<strong>Nick Liên
                                                    Quân&nbsp;đa dạng</strong></span></span></td>
                                    <td><span style="color:#000000"><span style="font-size:16px"><strong>⭐ Nhiều lựa chọn
                                                    acc đa dạng: mệnh gíá, tướng, trang phục,...</strong></span></span></td>
                                </tr>
                            </tbody>
                        </table>
                        <p><span style="font-size:16px"><strong><a href="https://WebTrader/garena/lien-quan"
                                        target="_blank">Web mua bán nick Liên Quân Mobile UY TÍN - GIÁ RẺ</a></strong>.
                                <strong>Shop bán acc<strong> </strong>Liên Quân</strong> - <strong>Tài khoản Liên Quân
                                    Vip</strong>, <strong>Nick Liên quân có đá quý.</strong>&nbsp;</span></p>
                        <p><span style="font-size:16px"><span style="color:#000000">Ngoài mua&nbsp;bán nick liên
                                    quân&nbsp;website còn</span> <strong><a href="https://WebTrader/mua-the"
                                        target="_blank"><span style="color:#c0392b">bán thẻ
                                            Garena</span></a></strong>,&nbsp;<a href="https://WebTrader/dich-vu/nap-quan-huy"
                                    target="_blank"><span style="color:#e67e22"><strong>mua bán quân huy giá
                                            rẻ</strong></span></a>,<a href="https://WebTrader/garena/lien-quan-random-so-cap"
                                    target="_blank"> <strong>bán acc liên quân<strong> </strong>random</strong></a>,
                                <strong><a href="https://WebTrader/dich-vu/cay-thue-lien-quan">Cày thuê LQ</a> </strong>và rất
                ...
                <div class="m-l-10 m-r-10">
                    <form class="form-inline m-b-10" role="form" method="get" data-hs-cf-bound="true">
                        ...
                        <div class="col-md-3 col-sm-4 p-5 no-radius">
                            ...
                            <a class="btn c-square m-l-0 btn-danger" href="https://WebTrader/garena/lien-quan">Tất cả</a>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="search-list-product">
                            <form class="form-inline m-b-10" role="form" method="get" data-hs-cf-bound="true">
                                ...
                                <div class="col-md-3 col-sm-4 p-5 no-radius">
                                    ...
                                    <a class="btn c-square m-l-0 btn-danger" href="https://WebTrader/garena/lien-quan"
            ...
            <div class="data_paginate paging_bootstrap paginations_custom" style="text-align: center">
                <ul class="pagination pagination-sm">
                    ...
                    <li class="page-item"><a class="page-link" href="https://WebTrader/garena/lien-quan?page=2">2</a></li>
                    <li class="page-item"><a class="page-link" href="https://WebTrader/garena/lien-quan?page=3">3</a></li>
                    <li class="page-item disabled hidden-xs"><span class="page-link">...</span></li>
                    <li class="page-item hidden-xs"><a class="page-link"
                            href="https://WebTrader/garena/lien-quan?page=24">24</a></li>
                    <li class="page-item"><a class="page-link" href="https://WebTrader/garena/lien-quan?page=2"
                            rel="next">»</a></li>
                </ul>
            </div>
            <div class="data_paginate paging_bootstrap paginations_custom" style="text-align: center">
            ...
            <script type="text/javascript">
                $('#search').click(function() {
                    ...
                    if ($('#page').val() != "") {
                        location.href = 'https://WebTrader' + '/lien-quan?page=' + page;
                    }
                })
            </script>
            <div class="tab-vertical tutorial_area">
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        ...
                        <div id="tab1" class="panel-collapse collapse in" aria-expanded="true" style="">
                            <div class="panel-body">
                                <p><strong>Lưu ý : <span style="color:#e74c3c">Mục tìm nick theo đá quý là :&nbsp;Đá quý và
                                            các món trong khó báu như tướng và skin hiếm có&nbsp;trong kho
                                            báu</span></strong></p>
                                <p>Ngoài&nbsp; <strong>shop bán acc liên quân</strong>&nbsp;Shop còn có các dịch vụ khác như
                                    <strong><a href="https://WebTrader/dich-vu/ban-quan-huy" target="_blank">mua bán quân
                                            huy giá rẻ</a></strong>, <strong><a
                                            href="https://WebTrader/mua-ban-nick-game-random" target="_blank">bán nick liên
                                            quân&nbsp;</a></strong><strong><a
                                            href="https://WebTrader/mua-ban-nick-game-random"
                                            target="_blank">random</a>&nbsp;,<span style="color:#e74c3c">bán thẻ garena
                                            giá&nbsp; rẻ và hơn 40 dịch vụ game khác</span></strong> tại&nbsp;<strong><a
                                            href="https://WebTrader/dich-vu"
                                            target="_blank">https://WebTrader/dich-vu</a>&nbsp;(<a
                                            href="https://WebTrader/dich-vu" target="_blank">click</a>)</strong>
                                </p>
                                <p><strong>Link bán quân huy</strong> :&nbsp;<strong><a
                                            href="https://WebTrader/dich-vu/lien-quan"
                                            target="_blank">https://WebTrader/dich-vu/lien-quan</a>&nbsp;(<a
                                            href="https://WebTrader/dich-vu/lien-quan" target="_blank">click</a>)</strong>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h5 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="">Group - fanpage cộng
                                    đồng <i class="glyphicon glyphicon-flag"></i></a>
                            </h5>
                        </div>
                        <div id="tab1" class="panel-collapse collapse in" aria-expanded="true" style="">
                            <div class="panel-body">
                                <p>Mình có tạo group về liên quân&nbsp;để anh em giao lưu. Ae ấn tham gia group và like page
                                    nhé</p>
                                <p>Group :&nbsp;Quanplay - Cộng Đồng Liên Quân Mobile</p>
                                <p>Link : <strong><a href="https://www.facebook.com/groups/lienquan.9/"
                                            target="_blank">https://www.facebook.com/groups/lienquan.9/</a></strong></p>
                                <p>Group :&nbsp;Hội Con Gái Chơi Liên Quân Mobile</p>
                                <p>Link :&nbsp;<a href="https://www.facebook.com/groups/lienquanmobile.girl/"
                                        target="_blank">https://www.facebook.com/groups/lienquanmobile.girl/</a></p>
                                <p>&nbsp;</p>
                            </div>
                        </div>
                    </div>
