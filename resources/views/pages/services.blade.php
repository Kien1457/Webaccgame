            ...
            <div class="container">
                <div class="row">
                    <div class="alert alert-info" role="alert">
                        <h2 class="alert-heading">Dịch vụ con game liên quân</h2>
                        <p></p>
                        <p><span style="color:#e74c3c"><strong>Dịch vụ con game liên quân . </strong></span><strong>Dịch vụ
                                bán skin và tướng giá rẻ game liên quân&nbsp;</strong></p>
                        <p></p>
                    </div>
                            ...
                            <form class="form-inline m-b-10" role="form" method="get" data-hs-cf-bound="true">
                                ...
                                <div class="col-md-3 col-sm-4 p-5 no-radius">
                                    ...
                                    <a class="btn c-square m-l-0 btn-danger"
                                        href="https://nick.vn/dich-vu/dich-vu-lien-minh-toc-chien">Tất cả</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                    ...
                    <div class="c-content-title-1">
                        <h3 class="c-center c-font-uppercase c-font-bold">Danh mục dịch vụ con</h3>
                    ...
                    <div class="row row-flex-safari game-list">
                            ...
                            <div class="classWithPad">
                                <div class="news_image">
                                    <img style="position: absolute;max-width: 79px;height: auto;top: -5px;right: -6px;z-index: 1122;"
                                        src="img/giam.png" />
                                    <a href="{{ route('dichvucon', 'nick-lien-quan') }}" title="Danh Mục Game Free Fire"
                                        class="">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="{{ route('dichvucon', 'nick-lien-quan') }}" title="Danh Mục Game Liên Quân">Danh Mục
                                            Game Liên Quân</a>
                                    </h2>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom72 view">
                                                <a href="{{ route('dichvucon', 'nick-lien-quan') }}" class=""
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                <div class="news_image">
                                    <img style="position: absolute;max-width: 79px;height: auto;top: -5px;right: -6px;z-index: 1122;"
                                        src="img/giam.png" />
                                    <a href="/danh-muc/danh-muc-game-free-fire" title="Danh Mục Game Free Fire"
                                        class="">
                                        <img src="img/danhmuc.gif" alt="Danh Mục Game Free Fire"></a>
                                </div>
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-lien-minh" title="Danh Mục Game Liên Minh">Danh Mục
                                            Game Liên Minh</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom75 view">
                                                <a href="/danh-muc/danh-muc-game-lien-minh" class=""
                                                    title="Danh Mục Game Liên Minh">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom75 {
                                                            border: none !important;
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-ngoc-rong" title="Danh Mục Game Ngọc Rồng">Danh
                                            Mục Game Ngọc Rồng</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    <p>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom76 view">
                                                <a href="/danh-muc/danh-muc-game-ngoc-rong" class=""
                                                    title="Danh Mục Game Ngọc Rồng">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom76 {
                                                            border: none !important;
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-pubg-mobile"
                                            title="Danh Mục Game Pubg Mobile">Danh Mục Game Pubg Mobile</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    <p>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom77 view">
                                                <a href="/danh-muc/danh-muc-game-pubg-mobile" class=""
                                                    title="Danh Mục Game Pubg Mobile">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom77 {
                                                            border: none !important;
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-zingspeed-mobile"
                                            title="Danh Mục Game ZingsPeed Mobile">Danh Mục Game ZingsPeed Mobile</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    <p>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom78 view">
                                                <a href="/danh-muc/danh-muc-game-zingspeed-mobile" class=""
                                                    title="Danh Mục Game ZingsPeed Mobile">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom78 {
                                                            border: none !important;
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-fo4" title="Danh Mục Game FO4">Danh Mục Game
                                            FO4</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom79 view">
                                                <a href="/danh-muc/danh-muc-game-fo4" class=""
                                                    title="Danh Mục Game FO4">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom79 {
                                                            border: none !important;
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-lang-la" title="Danh Mục Game Làng Lá">Danh Mục
                                            Game Làng Lá</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom80 view">
                                                <a href="/danh-muc/danh-muc-game-lang-la" class=""
                                                    title="Danh Mục Game Làng Lá">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom80 {
                                                            border: none !important;
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-dot-kich" title="Danh Mục Game Đột Kích">Danh Mục
                                            Game Đột Kích</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom81 view">
                                                <a href="/danh-muc/danh-muc-game-dot-kich" class=""
                                                    title="Danh Mục Game Đột Kích">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom81 {
                                                            border: none !important;
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                ...
                                <div class="news_title">
                                    <h2>
                                        <a href="/danh-muc/danh-muc-game-roblox" title="Danh Mục Game Roblox">Danh Mục
                                            Game Roblox</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom207 view">
                                                <a href="/danh-muc/danh-muc-game-roblox" class=""
                                                    title="Danh Mục Game Roblox">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom207 {
                                                            border: none !important;
