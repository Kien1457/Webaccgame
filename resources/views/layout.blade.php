...
<head>
    <meta charset="utf-8" />
    <title>Web Bán Nick, Có Đủ Mọi Loại Game Hót Thịnh Hành </title>
    ...
    <link rel="canonical" href="https://WebTrade.vn" />
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <meta content="" name="author" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="" />
    <meta property="og:title" content="Web Bán Nick, Có Đủ Mọi Loại Game Hót Thịnh Hành WebTrade" />
    ...
    <meta name="author" content="WebTrade" />
    ...
    <link href="{{ asset('frontend/css/bootstrap-social.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('frontend/css/cubeportfolio.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!-- END THEME STYLES -->
    <script src="{{ asset('frontend/js/jquery-2.1.0.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('frontend/js/bootstrap.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('frontend/js/owl.carousel.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('frontend/js/owl-carousel/slider.js') }}" type="text/javascript"></script>
    <script src="{{ asset('frontend/js/jquery-cookie/jquery.cookie.js') }}" type="text/javascript"></script>
...
<body
    ...
    <script>
        ...
        setTimeout(function() {
            if ($('h1').length < 1) {
                ...
                $(".h1tag").html("<h1>" + document.title + "</h1>");
            }
        }, 100);
    </script><!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NGBFK5Z" height="0" width="0"
            ...
            <div class="container">
                ...
                <nav class="c-top-menu c-pull-right m-t-10">
                    <ul class="c-links c-theme-ul">
                        <li>
                            Hotline: <a href="tel:08.6969.3000">03.29013.698</a>
                        </li>
                    ...
                    <nav
                        ...
                        <ul class="nav navbar-nav c-theme-nav">
                            ...
                            <li class="c-menu-type-classic"><a rel="" href="/dich-vu"
                                    class="c-link dropdown-toggle ">Dịch vụ game</a></li>
                            <li class="c-menu-type-classic"><a rel="" href="/mua-the"
                                    class="c-link dropdown-toggle ">Mua thẻ</a></li>
                            <li class="c-menu-type-classic">
                                <a rel="" href="/nap-the" class="c-link dropdown-toggle ">Nạp tiền<span
                            ...
                            <li class="c-menu-type-classic">
                                ...
                                <ul id="children-of-42" class="dropdown-menu c-menu-type-classic c-pull-left ">
                                    <li class="c-menu-type-classic"><a rel="Blogs Game" href="{{ route('blogs') }}"
                                            class="">Blogs</a></li>
                                    @foreach ($blogs_huongdan as $key => $bloghd)
                                        <li class="c-menu-type-classic"><a rel=""
                                                href="{{ route('blogs_detail', $bloghd->slug) }}"
                            ...
                            <li class="c-menu-type-classic">
                                ...
                                <ul id="children-of-41" class="dropdown-menu c-menu-type-classic c-pull-left ">
                                    ...
                                    <li class="c-menu-type-classic"><a target='_blank' rel=""
                                            href="https://WebTrade/blog/huong-dan-nap-tien-tu-dong-bang-atm-vao-nickvn"
                                            class="">Hướng dẫn nạp ATM tự động</a></li>
                                </ul>
                            </li>
                            <li class="c-menu-type-classic">
                                ...
                                <ul id="children-of-42" class="dropdown-menu c-menu-type-classic c-pull-left ">
                                    ...
                                    <li class="c-menu-type-classic"><a rel="" href="/dich-vu-game"
                                            class="">Dịch Vụ Game</a></li>
                                    <li class="c-menu-type-classic"><a rel=""
                                            href="https://WebTrade/blog/dieu-khoan-su-dung-website-nickvn"
                                            class="">Điều khoản sử dụng website</a></li>
                                    <li class="c-menu-type-classic"><a rel=""
                                            href="https://WebTrade/blog/chinh-sach-tai-nickvn"
                                            class="">Ch&iacute;nh s&aacute;ch tại WebTrade</a></li>
                                </ul>
                            </li>
                    ...
                    @foreach ($slider as $key => $sli)
                        <div class="item">
                            <a href="#" alt="{{ $sli->title }}">
                                <br>
                                <img src="{{ asset('uploads/slider/' . $sli->image) }}" alt="{{ $sli->title }}"
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="c-container c-first">
                           ...
                           <h3 class="c-font-uppercase c-font-bold c-font-white">Về <span class="c-theme-font">WebTrade</span>
                           ...
                           <li><a href="/tuyen-dai-ly-cung-cap-nick-tai-nickvn">Tuyển Đại Lý cung cấp nick tại WebTrade</a></li>
                           <li><a href="/lien-he-gop-y"> Liên hệ/góp ý</a></li>
                           </ul> -->
                            <p><span style="color:#ffffff"><span
                                        style="font-size:22px"><strong>&nbsp;</strong></span></span><span
                                    style="color:#16a085"><span
                                        style="font-size:22px"><strong>WebTrade</strong></span></span>&nbsp; &nbsp;<a
                                    href="http://www.dmca.com/Protection/Status.aspx?ID=6766daa6-8986-40c5-b282-a9c9e6a883de&amp;refurl=https://WebTrade/"
                            ...
                            <p><span style="font-size:14px"><span style="color:#ffffff">Chuy&ecirc;n mua b&aacute;n
                                        ...
                                        style="color:#ffffff">,&nbsp;an to&agrave;n,&nbsp;tin cậy, nhanh ch&oacute;ng.
                                        Giao dịch tự động 24/24</span></span></p>
                            <ul>
                                <li><strong><span style="font-size:14px"><a
                                                href="https://www.facebook.com/kiennguyen1347/?locale=vi_VN" target="_blank"><span
                                                    style="color:#ffffff">Tuyển Đại L&yacute; cung cấp nick tại
                                                    WebTrade</span></a></span></strong></li>
                                <li><strong><span style="font-size:14px"><a href="https://support-leagueoflegends.riotgames.com/hc/vi"
                                                target="_blank"><span style="color:#ffffff">Li&ecirc;n
                                                    hệ</span></a></span></strong></li>
                    ...
                    <div class="col-md-4">
                        <div class="c-container c-last">
                           ...
                           <li><i class="icon-envelope c-theme-font"></i> <a href="mailto:admin@WebTrade" class="c-font-regular">admin@WebTrade</a></li>
                           <li><i class="icon-clock c-theme-font"></i><span class="c-font-regular">8h-11h30 & 13h30-22h</span></li>
                           </ul> -->
                            <h2><span style="color:#ffffff"><span style="font-size:22px"><strong>CH&Uacute;NG
                                            T&Ocirc;I Ở Đ&Acirc;Y</strong></span></span></h2>
                            <h3><span style="color:#ffffff"><span style="font-size:16px">Ch&uacute;ng t&ocirc;i
                                        l&agrave;m việc một c&aacute;ch chuy&ecirc;n nghiệp, uy t&iacute;n, nhanh
                                        ch&oacute;ng v&agrave; lu&ocirc;n đặt quyền lợi của bạn l&ecirc;n h&agrave;ng
                                        đầu.</span></span></h3>
                            <p>&nbsp;</p>
                            <p><span
                                    style="color:#ffffff">&nbsp;<strong>Hotline:</strong>&nbsp;<strong>03.29013.698</strong></span>
                            </p>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="fb-page"
                            ...
                            <blockquote
                                cite="https://www.facebook.com/CSKH-Tr%C3%B9m-C%C3%A1c-Game-Online-102414321166624/"
                                class="fb-xfbml-parse-ignore"><a
                                    href="https://www.facebook.com/CSKH-Tr%C3%B9m-C%C3%A1c-Game-Online-102414321166624/">WebTrade</a>
                            </blockquote>
                        </div>
                    </div>
                </div>
    ...
    <div class="c-layout-go2top">
        {{-- <i class="fa-solid fa-arrow-up"></i> --}}<img src="{{ asset('frontend/img/tải xuống.jpg') }}" alt="" width="100%"
            height="30px">
    </div>
    ...
    <script src="{{ asset('frontend/js/jquery.fancybox.min.js') }}" type="text/javascript"></script>
